...
import edu.kh.demo.dto.MemberDTO;
...
public class ParameterController {
	 ...
	 * - 주입되는 데이터는 매개변수와 타입이 맞게 형변환/파싱이 자동으로 수행됨
	 * 
	 * 	[기본 작성법]
	...
	public String paramTest3(
		...
		// {color=red, fruit=Apple, productName=아이폰, expiraionDate=2024-10-29}
