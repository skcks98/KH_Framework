...
public class ImgaeDeleteScheduling {
	...
	// @Scheduled(cron= "0,30 * * * * *") // 시계초 단위가 0,30인 경우 수행
	// @Scheduled(cron="0,15,30,45 * * * * *") // 시계초 단위가 0,15,30,45인 경우 수행
	...
	public void scheduling() {
		...
		//새로운배열, 새로운 배열의 몇번부터넣을지 인덱스, 복사를 어디까지 할건지)
