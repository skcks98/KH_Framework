...
public class TestWebSocketHandler extends TextWebSocketHandler{
	...
	// 연결할 클라이언트의 HttpSession을 가지고 있음
	// (attributes에 추가한 값)
	
	// 동기화 된 Set 생성
	private Set<WebSocketSession> sessions = Collections.synchronizedSet(new HashSet<>());// 중복 허용 x, 순서 유지
