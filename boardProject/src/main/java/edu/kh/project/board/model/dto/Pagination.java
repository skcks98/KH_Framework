...
public class Pagination {
	...
	// SETTER
	// 값을 새로 세팅하기에 setter 다 calculate 필요
	...
	private void calculate() {
		...
		// 한 페이지에 게시글이 10개씩 보여질 셩우
		// 게시글 수 95개 -> 10 page
		// 게시글 수 100 개 -> 10 page
		// 게시글 수 101 개 -> 11 page 
		
		maxPage = (int)Math.ceil((double)listCount / limit);  // 계산 식
		...
		startPage = (currentPage - 1) / pageSize * pageSize + 1;	// 5page를 보고 있으면 계산 결과 startPage는 1페이지다.
		...
		endPage = pageSize -1 + startPage; // pageSize 10 -> endPage:10	
